...
function generarFlyer(){
  ...
  if(fotoInput.files && fotoInput.files[0]){
    ...
    reader.onload = function(e){
      fotoHTML = `<img src="${e.target.result}" alt="Foto" style="width:100%;max-height:300px;object-fit:cover;margin:12px 0" />`;
...
function renderFlyer(nombre,tipo,ubicacion,fecha,telefono,recompensa,descripcion,fotoHTML){
  ...
  preview.innerHTML = `
    <div id="flyer-capture" style="background:#fff;border:3px solid #E53935;padding:16px;max-width:600px;margin:0 auto">
      ...
      <div style="font-size:28px;font-weight:800;margin-top:16px;text-align:center">📞 ${telefono}</div>
    </div>
  `;
}
